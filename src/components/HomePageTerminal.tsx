...
interface HomePageTerminalProps {
  id: string
}

const HomePageTerminal: React.FC<HomePageTerminalProps> = ({ id }) => {
  ...
  const emailLink = `mailto:${socialData.socials.find((social) => social.name === "Email")?.href || "mikael.galliot@proton.me"}`
            ...
            {isBooting ? (
              ...
              <>
                ...
                {currentCommand >= 4 && (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      <motion.button
                        onClick={() => handleCommand("contact-me")}
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                      ...
                      <motion.button
                        ...
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="px-4 py-2 bg-blue-600/20 border border-blue-500/50 rounded text-blue-400 hover:bg-blue-600/30 transition-all text-sm font-mono"
                      >
                        ./classic-mode
                      </motion.button>
                    </div>
                ...
                {currentCommand >= 4 && (
                  ...
                  >
                    {[
                      { icon: Github, href: githubLink, cmd: "github" },
                      { icon: Linkedin, href: linkedinLink, cmd: "linkedin" },
                      { icon: Mail, href: emailLink, cmd: "email" },
