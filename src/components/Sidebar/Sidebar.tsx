...
const Sidebar: React.FC<SidebarProps> = ({ navItems, isSidebarOpen: isSidebarOpen, handleSidebar: handleSidebar }) => {
  return (
    <div
      className={` ${isSidebarOpen ? "w-48" : "w-0"} content-box shrink-0 text-white flex overflow-hidden transition-all duration-300 overflow-y-hidden bg-gray-800 h-[calc(100dvh)] transform ${isSidebarOpen ? "" : "-translate-x-full"} font-[RobotoSlab-Bold]`}
    >
      <div className="container justify-center items-center text-center">
        ...
        <div className="flex-col shrink content-center sidebarLinks nav-links overflow-y-auto">
